...
class SQLInjectionTester:
    ...
    async def _call_ai_api(self, payload: str, response_text: str = "", language: str = "unknown",
                           url: str = "", parameter: str = "", status_code: int = 0,
                           response_time_ms: float = 0.0, headers: dict = None) -> Dict:
        if not self.use_ai:
        ...
        async with self._semaphore:
            ...
            try:
                ...
                if method == "post":
                    ...
                    headers = {k.lower(): v for k, v in r.headers.items()} if r else {}
